...
<form action="//LeanAgileTraining.us9.list-manage.com/subscribe/post?u=df06d21576b6ebaa8f4189dbc&amp;id=35a72ff9fe" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate>
...
<div class="mc-field-group">
    <label for="mce-MMERGE4">Business </label>
...
<div class="mc-field-group">
    <label for="mce-MMERGE7">Zip </label>
...
<li><input type="radio" value="text" name="EMAILTYPE" id="mce-EMAILTYPE-1"><label for="mce-EMAILTYPE-1">text</label></li>
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_df06d21576b6ebaa8f4189dbc_35a72ff9fe" tabindex="-1" value=""></div>
    <div class="clear">
    <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button">
    <div class="unsubscribe" style="float: right; display: inline-block; padding: 10px 20px 0 0">
        <a href="https://LeanAgileTraining.us9.list-manage.com/unsubscribe?u=df06d21576b6ebaa8f4189dbc&id=35a72ff9fe" target="_blank">
            Unsubscribe
        </a>
    </div>
    </div>
