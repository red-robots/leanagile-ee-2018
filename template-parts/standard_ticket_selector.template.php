...
<?php echo $datetime_selector; ?>
    ...
    <table id="tkt-slctr-tbl-<?php echo $EVT_ID; ?>" class="tkt-slctr-tbl">
        ...
        <tr>
            ...
            <th id="remaining-<?php echo $EVT_ID; ?>" scope="col" class="ee-ticket-selector-ticket-remaining-th cntr">
                <?php
                echo apply_filters(
                    'FHEE__ticket_selector_chart_template__table_header_remaining_tickets',
